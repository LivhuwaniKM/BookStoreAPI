...
namespace BSCore
{
    public class JWTAuth
    {
        ...
        public JWTAuth(IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
        ...
        private void AppendTokenToRequestHeader(string token)
        {
        ...
        public string? GetJwtToken()
        {
            ...
            {
                AppendTokenToRequestHeader(token);
                return token;
            }
            return null;
        }
